"""
FastAPI MCP Server for Ms365 MCP Server
...
app = FastAPI(title="Ms365 MCP Server", version="1.0.0")
...
async def startup_event():
    ...
    logger.info("Ms365 MCP Server started")


@app.on_event("shutdown")
async def shutdown_event():
    """Cleanup on server shutdown"""
    logger.info("Ms365 MCP Server stopped")
...
async def health_check():
    ...
    return {"status": "healthy", "server": "ms365"}
