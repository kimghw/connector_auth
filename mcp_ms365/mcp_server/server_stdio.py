"""
STDIO MCP Server for Ms365 MCP Server
...
class StdioMCPServer:
    ...
    def __init__(self):
        ...
        logger.info(f"Ms365 MCP Server STDIO Server initialized")
    ...
    async def run(self):
        ...
        logger.info(f"Ms365 MCP Server STDIO Server started")
        ...
        try:
            ...
            logger.info("Ms365 MCP Server STDIO Server stopped")
