...
try:
    ...
    # Fall back to direct import (when running directly)
    from tool_definitions import MCP_TOOLS
...
# Import attachment services - use absolute imports when running directly
try:
    # Try relative imports first (when running as module)
    from ..file_manager import FileManager
    from ..metadata.manager import MetadataManager
except ImportError:
    # Fall back to sys.path based imports (when running directly)
    from file_manager import FileManager
    from metadata.manager import MetadataManager
