...
MCP_TOOLS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "required": ["user_email", "message_id"]
        }
    },
    {
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "required": ["user_email", "message_id", "attachment_id"]
        }
    },
    {
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "user_email": {"type": "string", "description": "Sender email address"},
                "to_recipients": {
                    "type": "array",
                    "items": {"type": "string"},
            ...
            "required": ["user_email", "to_recipients", "subject", "body"]
        }
    },
    {
        "name": "reply_to_email",
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "comment": {"type": "string", "description": "Reply comment"},
                "reply_all": {
                    "type": "boolean",
                    "default": False,
            ...
            "required": ["user_email", "message_id", "comment"]
        }
    },
    {
        "name": "forward_email",
        ...
        "inputSchema": {
            ...
            "required": ["user_email", "message_id", "to_recipients"]
        }
    },
    {
        "name": "delete_email",
