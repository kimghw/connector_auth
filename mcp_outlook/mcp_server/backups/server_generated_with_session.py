...
from graph_types import FilterParams, SelectParams
...
async def handle_mail_search(args: Dict[str, Any]) -> Dict[str, Any]:
    """Route to GraphMailQuery.mail_search with session or legacy support"""
    user_email = args["user_email"]
    ...
    try:
        ...
        return await service_instance.mail_search(
            user_email=user_email,
            search=search,
