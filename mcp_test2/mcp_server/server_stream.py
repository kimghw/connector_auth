"""
Streaming MCP Server for Test2 MCP Server
...
server_module_dir = os.path.join(grandparent_dir, "mcp_test2")
...
def _load_mcp_tools() -> List[Dict[str, Any]]:
    ...
    2. mcp_editor/mcp_{profile_name}/tool_definition_templates.yaml (profile-specific)
       - Uses test2 which is set correctly at generation time for reused profiles
    ...
    if yaml_path_str:
        ...
        yaml_path = Path(current_dir).parent.parent / "mcp_editor" / "mcp_test2" / "tool_definition_templates.yaml"
...
async def handle_convert_file_to_text(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # ========================================
    call_args = {}
    call_args["input_path"] = input_path

    # ========================================
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.process(**call_args)
...
async def handle_process_directory(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # ========================================
    call_args = {}
    call_args["directory_path"] = directory_path

    # ========================================
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.process_directory(**call_args)
...
async def handle_save_file_metadata(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # - 사용자 입력이 없으면 기본값 병합
    # ========================================
    additional_metadata_sig_defaults = {}
    additional_metadata_data = merge_param_data({}, additional_metadata, additional_metadata_sig_defaults)
...
async def handle_search_metadata(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.search_metadata(**call_args)
...
async def handle_convert_onedrive_to_text(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.process_onedrive(**call_args)
...
async def handle_get_file_metadata(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.get_metadata(**call_args)
...
async def handle_delete_file_metadata(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    # Step 3: 서비스 메서드 호출
    # ========================================
    return await file_manager.delete_metadata(**call_args)
...
class StreamableHTTPMCPServer:
    ...
    def __init__(self):
        ...
        self.setup_routes()
        logger.info(f"Test2 MCP Server StreamableHTTP Server initialized")
    ...
    async def on_startup(self, app):
        """서버 시작 시 실행"""
        logger.info(f"Test2 MCP Server StreamableHTTP Server starting on port {app['port']}")
    ...
    async def on_cleanup(self, app):
        """서버 종료 시 정리"""
        logger.info(f"Test2 MCP Server StreamableHTTP Server shutting down")
    ...
    def run(self, host: str = '0.0.0.0', port: int = 8001):
        ...
        logger.info(f"Starting Test2 MCP Server StreamableHTTP Server on {host}:{port}")
...
if __name__ == "__main__":
    ...
    port = int(os.environ.get("MCP_SERVER_PORT", 8092))
