"""
STDIO MCP Server for Test MCP Server
...
class StdioMCPServer:
    ...
    def __init__(self):
        ...
        logger.info(f"Test MCP Server STDIO Server initialized")
    ...
    async def run(self):
        ...
        logger.info(f"Test MCP Server STDIO Server started")
        ...
        try:
            ...
            logger.info("Test MCP Server STDIO Server stopped")
